 ...
 */
public class ApproveConnectionServlet extends HttpServlet {
    @Override
    public void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        ApproveConnectionParams params =
                (ApproveConnectionParams) xml_stream.fromXML(req_body.toString());

        Object result = null;

        result = (Object) facade.approveConnection(params);
