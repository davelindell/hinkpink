...
/**
 * Created by lindell on 7/18/15.
 */
public class SubmitNewGameServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        NewGameParams params =
                (NewGameParams)xml_stream.fromXML(req_body.toString());

        Object result = null;

        result = (Object)facade.submitNewGame(params);
